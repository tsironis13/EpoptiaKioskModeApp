package kioskmode.com.epoptia.kioskmodephone.pdfviewer;
        ...
        mBinding.backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                getActivity().getSupportFragmentManager()
                        .beginTransaction()
                        .replace(R.id.kioskModeLlt, SystemDashboardFrgmt.newInstance(stationId, cookie, url, stationName, workerUsername, workerId), getResources().getString(R.string.station_workers_frgmt))
                        .commit();
            }
        });
    }
